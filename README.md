...
Also, notice that the time between the SYN packets is only a few milliseconds. This rapid and repetitive behavior, combined with multiple ports being scanned, strongly indicates an automated scan.  
